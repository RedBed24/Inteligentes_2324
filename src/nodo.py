...
class Nodo:
    ...
    def __str__(self) -> str:
        ...
        return f"[{self.id}][({round(self.costo_distancia, 3):.3f},{round(self.costo_max_desnivel, 3):.3f}),{self.estado.id},{id_parent},{direction},{self.profundidad},{round(self.heuristica, 3)},{round(self.valor, 3):.4f}]"
